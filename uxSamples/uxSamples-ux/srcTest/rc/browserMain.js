...
(function () {
  ...
  require.config({
    ...
    paths: {
      ...
      nmodule: '/module',
      'nmodule/uxSamples': 'build/karma/src',
      'nmodule/uxSamplesTest': 'build/karma/srcTest',
  ...
  define('nmodule/uxSamples/rc/uxSamples.built.min');
  ...
  require([ 'niagara-test-server/karmaUtils',
     ...
     */
    //testOnly('rc/uxSamples');
    testOnly('');

    karmaUtils.setupAndRunSpecs({
      user: 'admin',
      pass: 'asdf1234',
      specs: [ 'nmodule/uxSamplesTest/rc/spec/allSpecs' ]
    }, function (err) {
